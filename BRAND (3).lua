------------------------------------------------
-- This Source Was Developed By (BRAND) @IQ_BRAND.--
--   This Is The Source Channel @CXRCX .   --
--                - BRAND -                 --
--        -- https://t.me/CXRCX --         --
------------------------------------------------ 
DevBRAND  = dofile("./libs/redis.lua").connect("127.0.0.1", 6379)
...
Dev_BRAND(msg.chat_id_, msg.id_, 1, "⌁︙عذرا عزيزي ↫ ["..dp.first_name_.."](T.me/"..UserName..")".."\n"..text, 1, 'md')
return false
end
...
⌁︙[Developer](https://t.me/IQ_BRAND)
┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉
⌁︙[Tws BRAND](https://t.me/IQA_bot)
]]
...
Dev_BRAND(msg.chat_id_, result.id_, 1,''..BRANDTTEAM[math.random(#BRANDTTEAM)], 1, 'html') 
else  
...
Dev_BRAND(msg.chat_id_, result.id_, 1,''..BRANDTTEAM[math.random(#BRANDTTEAM)], 1, 'md') 
end 
...
Dev_BRAND(msg.chat_id_, msg.id_, 1, '⌁︙هذا الامر للمالكين والمطورين فقط', 1, 'md')
end
--     Source BRAND     --
--    Set  Constructor    --
...
local UserName = (dp.username_ or "CXRCX")
Dev_BRAND(msg.chat_id_, msg.id_, 1, "⌁︙مالك المجموعه ↫ ["..dp.first_name_.."](T.me/"..UserName..")", 1, "md")  
end,nil)   
end
end
end,nil)   
...
Dev_BRAND(msg.chat_id_, msg.id_, 1, '⌁︙جاري تحديث سورس بروكس', 1, 'md') 
...
Dev_BRAND(msg.chat_id_, msg.id_, 1, '⌁︙Channel ↬ [@CXRCX]', 1, 'md')    
end 
--     Source BRAND     --
...
local BRANDname = '⌁︙العضو ↫ ['..dp.first_name_..'](tg://user?id='..dp.id_..')'
local BRANDid = '⌁︙ايديه ↫ `'..dp.id_..'`'
local BRANDtext = '⌁︙قام بالتعديل على '..Media
